CKEDITOR.plugins.add('pyrofiles_voice',
{
	init : function(editor)
	{
		...
		CKEDITOR.dialog.addIframe('pyrofiles_voice_dialog', 'Files Voice From PRD', SITE_URL + 'admin/wysiwyg/files_wysiwyg_audio',700,400,function(){}, {
			onLoad: function(){
		...
		editor.ui.addButton('pyrofiles_voice',{ label:'Upload or insert voice from library.', command:'pyrofiles_voice', icon:this.path+'images/icons.png' });
