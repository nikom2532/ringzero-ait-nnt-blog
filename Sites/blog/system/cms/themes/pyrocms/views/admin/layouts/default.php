...
<body>
	...
	<footer class="clearfix">
		<div class="wrapper">
			<p class="credits">Copyright &copy; 2014 - <?php echo date('Y'); ?> Web Blog National News Bureau of Thailand  &nbsp; <span>Version <?php echo CMS_VERSION.' '.CMS_EDITION; ?> &nbsp; Rendered in {elapsed_time} sec. using {memory_usage}.</span></p>
