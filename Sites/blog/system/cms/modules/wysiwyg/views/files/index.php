...
<div id="files_browser">
	...
	<div id="files_right_pane">
		...
		<?php if ($current_folder): ?>
			<h3>โฟลเดอร์ : <?php echo $current_folder->name ?> <span style="color:red">[ไฟล์อื่นๆ]</span></h3>  
			<!-- subfolders -->
				...
				<tbody>
					...
					<tr class="<?php echo alternator('', 'alt') ?>">
						...
						<td class="name-description">
							...
							<p style="font-size:12px;"><?php echo $file->description ?></p>
						</td>
						<td class="filename">
							<p><?php echo $file->filename ?></p>
							<p style="font-size:12px;"><?php echo format_date($file->date_added) ?></p>
						</td>
