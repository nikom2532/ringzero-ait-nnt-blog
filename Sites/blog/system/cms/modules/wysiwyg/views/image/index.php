...
<div id="files_browser">
	...
	<div id="files_right_pane">
		...
		<div class="tab-content">
			<div class="form_inputs tab-pane active" id="blog-images-tab">
			...
			<div class="form_inputs tab-pane" id="blog-images-prd-tab">
				<?php
					echo '<br><h1 style="color:red;">'.$title_prd.'</h1>';
				?>
					<table class="table-list-prd" border="0" cellspacing="0">
						<thead>
							<tr>
								<th><?php echo lang('files:type_i') ?></th>
								<th><?php echo lang('files:name') . '/' . lang('files:description') ?></th>
