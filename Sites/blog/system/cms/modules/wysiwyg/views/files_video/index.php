...
<div id="files_browser">
	...
	<div id="files_right_pane">
		...
		<?php if ($current_folder): ?>
			<h3>โฟลเดอร์ : <?php echo $current_folder->name ?> <span style="color:red">[ไฟล์วีดีโอ]</span></h3>  
			<!-- subfolders -->
			...
			<table class="table-list" border="0" cellspacing="0">
				...
				<!--
					...
					<!-- insert form prd -->
						...
						<tr class="<?php echo alternator('', 'alt') ?>">
							<td class="image">
								<button onclick="javascript:insertVideo('<?php echo $news_item->NT10_VDOID."', '".htmlentities(addslashes($news_item->NT10_VDOName))."', '".$news_item->url."', '".$news_item->url ?>');">
									Insert
								</button>
							</td>
							<td class="name-description">
