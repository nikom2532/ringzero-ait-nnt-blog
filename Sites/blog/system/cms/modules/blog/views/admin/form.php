		...
		<fieldset>
			<ul>
				<li>
					...
					<p>หรือ เลือกข่าวเก่าจากถังข้อมูล :</p> <select id=""><option value="0">-- ไม่เลือก --</option><option value="1">ข่าวดิบ</option><option value="2">ข่าวเผยแพร่</option></select>
				</li>
				...
				<li>
					<label for="category_id"><?php echo lang('blog:category_label') ?> <span>*</span></label>
					<div class="input">
