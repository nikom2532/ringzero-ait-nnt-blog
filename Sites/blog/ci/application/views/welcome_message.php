...
<div id="container">
	...
	<div id="body">
			<div class="row">
		<p style="border-radius: 5px;padding: 5px;color:#fff;background-color:#0404F5;width: 15%;text-align:center;float: left;">
			PRD NEWS
		</p>
		<a href="rawnews">
...
<?php
					...
					echo $ii.'). <img src="http://thainews.prd.go.th/centerapp/Common/GetFile.aspx?FileUrl='.$news_item->NT11_PicPath.'" align="left" hspace="5" width="150" height="100"> '.$news_item->NT01_NewsTitle; 
					echo '<br> เวลา '.$news_item->NT01_CreDate.' View ['.$view.']';
