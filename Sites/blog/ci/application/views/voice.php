...
<?php
					...
					echo $ii.'). '.$news_item->NT01_NewsID.' ID ไฟล์ :'.$news_item->NT12_VoiceID; 
					echo '<br>'.$news_item->NT12_VoiceName; 
					echo '<p><audio src="'.$news_item->NT12_VoicePath.'" controls>
  						Your browser <code>does not support the audio</code>.
					  </audio></p>';	
					echo '<br>'.$news_item->NT12_VoicePath;
?>					
			</p>
		</div>
