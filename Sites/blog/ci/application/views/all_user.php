...
?>
		<div class="odd">
			...
			<div class="col-2" style="width: 80%;float: left; ">
<?php
			
			echo $ii.'). ID : '.$news_item->UserID.' Name : '.$news_item->Title.' '.$news_item->FName.' '.$news_item->LName; 
			echo '<br><p> System : '.$news_item->System.' PositionType : '.$news_item->PositionType.' Career : '.$news_item->Career;
			echo '</p><p> เลขบัตรประชาชน : '.$news_item->IDCard.' Department : '.$news_item->Department.' Region '.$news_item->Region;
			
			echo '</p><p> Tumbon : '.$news_item->Tumbon.' Ampur : '.$news_item->Ampur.' Province : '.$news_item->Province;	
			echo '</p><p> username : <strong>'.$news_item->Username.'</strong> password : <strong>'.$news_item->SC03_Password.'</strong>'; 
			echo '</p><hr>';
?>
			</div>
		</div>
